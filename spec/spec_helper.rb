...
=end
  ...
  config.before :example do
    ...
    ActiveRecord::Base.connection.instance_eval do
      create_table(:people) { |t| t.string :name; t.boolean :active }
      create_table(:vendors) { |t| t.integer :person_id; t.string :name }
    end
    ...
    @person = Person.create! name: 'Aaron', active: true
    @person2 = Person.create! name: 'Fred', active: false
    @vendor = Vendor.create! name: 'Vendor!', person: @person
    @vendor2 = Vendor.create! name: 'Vendor2', person: @person2
  end
end
